package com.sundeep.Rado_Whatsapp_Toolkit.Addons.ImageCropper.NormalCrop.sample.data;

import android.net.Uri;
import android.support.annotation.DrawableRes;

import com.sundeep.Rado_Whatsapp_Toolkit.R;
import com.sundeep.Rado_Whatsapp_Toolkit.Addons.ImageCropper.NormalCrop.sample.App;
...
//        Log.d("FilePathInApp",App.getInstance().getFilesDir()+"/"+System.currentTimeMillis() + ".png");
