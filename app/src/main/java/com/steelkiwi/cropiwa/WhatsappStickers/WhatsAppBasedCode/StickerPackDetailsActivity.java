...
public class StickerPackDetailsActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        boolean isNewlyCreated=getIntent().getBooleanExtra("isNewlyCreated",false);
...
//    }
    ...
    private void startGalleryApp() {
        if (Permissions.isGranted(StickerPackDetailsActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
    ...
    private void addStickerPackToWhatsApp(StickerPack sp) {
        ...
        intent.putExtra(EXTRA_STICKER_PACK_AUTHORITY, BuildConfig.APPLICATION_ID);
