...
public class StickerContentProvider extends ContentProvider {
    ...
    public static Uri AUTHORITY_URI = new Uri.Builder().scheme(StickerContentProvider.CONTENT_SCHEME).authority(BuildConfig.APPLICATION_ID).appendPath(StickerContentProvider.METADATA).build();
    ...
    public String getType(@NonNull Uri uri) {
        ...
        switch (matchCode) {
            case METADATA_CODE:
                return "vnd.android.cursor.dir/vnd." + BuildConfig.APPLICATION_ID + "." + METADATA;
            case METADATA_CODE_FOR_SINGLE_PACK:
                return "vnd.android.cursor.item/vnd." + BuildConfig.APPLICATION_ID + "." + METADATA;
            case STICKERS_CODE:
                return "vnd.android.cursor.dir/vnd." + BuildConfig.APPLICATION_ID + "." + STICKERS;
